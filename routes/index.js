...
var adminRoutesLoader = require('./admin');
...
module.exports = function(database) {
    ...
    var adminRoutes = adminRoutesLoader(db);
    ...
    router.get('/tickets', function (req, res) {
        ...
        shows.findOne({infoType: 'bannerText'})
            .then(function (bannerText) {
                banner = bannerText.data;
                return shows.findOne({infoType: 'enableShow'});
            })
            .then(function (item) {
                data = item.data;
                console.log(data);
    ...
    router.post('/checkout/payment_failed', function (req, res) {
        ...
        var routeScope = {};
        routeScope.purchaseRecords = db.collection('purchaseRecords');
            ...
            .then(function (purchaseItemList) {
                if (purchaseItemList.length == 0) {
                    ...
                    if (routeScope.purchaseItem.paymentCompleted) {
                        ...
                        routeScope.ticketCounts = db.collection('ticketAmounts');
